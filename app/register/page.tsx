      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-900 border-r border-slate-800/80 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-8 my-auto max-w-lg">
          ...
          <div className="grid grid-cols-2 gap-6 pt-6 border-t border-slate-800/80">
            <div>
              <p className="text-3xl font-black text-blue-400 font-mono">Seguro</p>
              <p className="text-xs text-slate-400 font-medium mt-1">Autenticación JWT & RLS</p>
            </div>
            <div>
              <p className="text-3xl font-black text-indigo-400 font-mono">Dinámico</p>
              <p className="text-xs text-slate-400 font-medium mt-1">Gestión de Roles Activos</p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-md bg-slate-900 border border-slate-800 p-8 sm:p-10 rounded-2xl shadow-2xl relative">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-10 pr-4 py-2.5 bg-slate-950 border border-slate-800 focus:border-blue-500 rounded-xl text-slate-100 placeholder-slate-600 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all font-medium"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  required
                  className="w-full pl-10 pr-10 py-2.5 bg-slate-950 border border-slate-800 focus:border-blue-500 rounded-xl text-slate-100 placeholder-slate-600 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all font-medium"
                />
                <button
                  type="button"
          ...
          <div className="mt-6 text-center border-t border-slate-800/80 pt-5">
            <p className="text-slate-400 text-xs">
              ...
              <a href="/login" className="text-blue-400 hover:text-blue-300 font-bold transition-colors underline underline-offset-4">
                Inicia sesión aquí
              </a>
            </p>
          </div>
