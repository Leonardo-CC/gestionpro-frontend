          ...
          <div className="bg-slate-900/60 border border-slate-800 p-5 rounded-2xl shadow-lg space-y-3">
            ...
            {isMiembro && (
              <Link
                ...
                className="w-full flex items-center justify-between p-3 bg-gradient-to-r from-amber-500/10 to-orange-500/10 hover:from-amber-500/20 hover:to-orange-500/20 border border-amber-500/30 rounded-xl text-xs font-semibold text-amber-300 transition-colors"
              >
